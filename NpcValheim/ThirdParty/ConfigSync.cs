...
// keep it verbatim here and consume it from Plugin.cs to sync our BepInEx config (teleporter
// cost/cooldown) from the server to every connecting client automatically.
#nullable enable
using System;
